...
<Col md={10} xl={6}>
        ...
        <Col md={6} xl={8}>
          <Card className="Recent-Users widget-focus-lg">
            <Card.Header>
              <Card.Title as="h5">Mentor Apllications</Card.Title>
            </Card.Header>
            ...
            <Card.Body className="border-bottom">
              <div className="row d-flex align-items-center">]
                ...
                <div className="col">
                  ...
                  <span className="d-block text-uppercase">Total Mentors</span>
                </div>
              </div>
            </Card.Body>
            <Card.Body>
              <div className="row d-flex align-items-center">
                ...
                <div className="col">
                  <h3 className="f-w-300">105</h3>
                  <span className="d-block text-uppercase">Total Mentees</span>
                </div>
              </div>
            </Card.Body>
          </Card> */}
